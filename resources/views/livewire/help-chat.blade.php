<div class="fixed bottom-4 right-4 z-[60] print:hidden">
    @if ($open)
        <div class="mb-3 flex h-[28rem] w-[22rem] max-w-[calc(100vw-2rem)] flex-col overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-2xl">
            ...
            <form wire:submit="send" class="flex gap-2 border-t border-slate-200 p-3">
    ...
    @endif
    <button type="button" wire:click="toggle" class="flex h-14 w-14 items-center justify-center rounded-full bg-teal-700 text-white shadow-lg hover:bg-teal-800" aria-label="Open stock assistant">
        <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 10h8M8 14h5M21 12c0 4.418-4.03 8-9 8a9.86 9.86 0 01-4.255-.942L3 20l1.06-3.185C3.388 15.71 3 13.912 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"/></svg>
    </button>
</div>
